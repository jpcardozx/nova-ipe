...
export function PropertyCarousel({
    ...
    useEffect(() => {
        ...
        for (let i = 0; i < Math.min(visibleSlides * 2, totalSlides); i++) {
            const idx = (nextIndex + i) % totalSlides;
            imagesToPreload.push(properties[idx].mainImage.url);
        }
                        ...
                        {properties.map((property, index) => (
                            ...
                            >
                                <PropertyCard
                                    ...
                                    priority={index < visibleSlides * 2} // Carregar com prioridade os primeiros slides
                                />
                            </div>
                        ))}
                    </div>
