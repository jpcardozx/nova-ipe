...
export const OptimizedIcons = {
    ...
    Star: createDynamicIcon('Star'), ChevronLeft: createDynamicIcon('ChevronLeft'),
    ChevronRight: createDynamicIcon('ChevronRight'),
    Award: createDynamicIcon('Award'),
    UserCheck: createDynamicIcon('UserCheck'),
    Building2: createDynamicIcon('Building2'),
    ...
    Zap: createDynamicIcon('Zap'),
    Calendar: createDynamicIcon('Calendar'),
    Filter: createDynamicIcon('Filter'),
    SlidersHorizontal: createDynamicIcon('SlidersHorizontal'),
    Clock: createDynamicIcon('Clock'),
    ImageOff: createDynamicIcon('ImageOff'),
    Sparkles: createDynamicIcon('Sparkles'),
    Scale: createDynamicIcon('Scale'),
    Camera: createDynamicIcon('Camera'),
    Share2: createDynamicIcon('Share2'),
    ArrowUpRight: createDynamicIcon('ArrowUpRight'),
};
