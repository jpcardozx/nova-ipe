...
export default function AppointmentsPage() {
    ...
    const loadAppointments = async () => {
        try {
            // Dados mais realistas para imobiliária
            const mockAppointments: Appointment[] = [
                {
                    id: '1',
                    client_name: 'Carlos Oliveira',
                    client_phone: '(11) 99999-1234',
                    client_whatsapp: '(11) 99999-1234',
                    client_email: 'carlos@email.com',
                    lead_id: 'lead-1',
                    property_id: 'prop-123',
                    property_title: 'Apartamento 3 quartos - Vila Madalena',
                    property_address: 'Rua Harmonia, 456 - Vila Madalena, São Paulo',
                    property_coordinates: { lat: -23.5505, lng: -46.6333 },
                    ...
                    type: 'viewing',
                    priority: 'high',
                    notes: 'Cliente muito interessado, primeira visita. Família com 2 filhos.',
                    preparation_notes: 'Levar planta do apartamento, fotos da área comum',
                    ...
                    assigned_agent: 'user123',
                    requires_keys: true,
                    key_location: 'Portaria do prédio',
                    parking_info: 'Vaga de visitante disponível',
                    special_instructions: 'Porteiro libera acesso até 17h'
                },
                {
                    id: '2',
                    client_name: 'Ana Paula Martins',
                    client_phone: '(11) 98888-7777',
                    client_whatsapp: '(11) 98888-7777',
                    property_id: 'prop-456',
                    property_title: 'Loft Centro - Investimento',
                    property_address: 'Rua Augusta, 1234 - República, São Paulo',
                    property_coordinates: { lat: -23.5431, lng: -46.6291 },
                    ...
                    type: 'viewing',
                    priority: 'medium',
                    notes: 'Investidora experiente, foco em rentabilidade',
                    preparation_notes: 'Levar planilha de rentabilidade, comparativo de aluguéis da região',
                    ...
                    assigned_agent: 'user123',
                    requires_keys: true,
                    key_location: 'Imobiliária parceira - Rua do Arouche',
                    special_instructions: 'Buscar chaves até 17h'
                },
                {
                    id: '3',
                    client_name: 'Roberto Silva',
                    client_phone: '(11) 99999-9012',
                    client_whatsapp: '(11) 99999-9012',
                    property_id: 'prop-789',
                    property_title: 'Apartamento 2 quartos - Pinheiros',
                    property_address: 'Rua Butantã, 789 - Pinheiros, São Paulo',
                    property_coordinates: { lat: -23.5629, lng: -46.6825 },
                    property_price: 4500, // Aluguel
                    ...
                    type: 'viewing',
                    priority: 'urgent',
                    notes: 'Mudança urgente de Recife, precisa decidir rápido',
                    preparation_notes: 'Levar documentos para locação, ficha cadastral',
                    travel_time_minutes: 25,
                    distance_km: 15.2,
                    confirmation_sent: false,
                    reminder_sent: false,
                    created_at: '2025-01-08T15:20:00.000Z',
                    updated_at: '2025-01-08T15:20:00.000Z',
                    assigned_agent: 'user123',
                    requires_keys: true,
                    key_location: 'Administradora - Rua Teodoro Sampaio',
                    parking_info: 'Estacionamento pago na rua',
                    special_instructions: 'Cliente chega de avião, confirmar horário'
                },
                {
                    id: '4',
                    client_name: 'Fernanda Costa',
                    client_phone: '(11) 99999-5678',
                    property_id: 'prop-321',
                    property_title: 'Casa 4 quartos - Itaim Bibi',
                    property_address: 'Rua Pedroso Alvarenga, 321 - Itaim Bibi, São Paulo',
                    property_coordinates: { lat: -23.5751, lng: -46.6742 },
                    property_price: 1750000,
                    ...
                    type: 'evaluation',
                    priority: 'high',
                    notes: 'Avaliação para venda',
                    outcome_notes: 'Casa em excelente estado, preço sugerido R$ 1.750.000',
                    client_feedback: {
                        interested: true,
                        rating: 5,
                        comments: 'Excelente atendimento, avaliação muito detalhada',
                    ...
                    updated_at: '2025-01-07T16:00:00.000Z',
                    assigned_agent: 'user123',
                    requires_keys: false
                }
            ]
