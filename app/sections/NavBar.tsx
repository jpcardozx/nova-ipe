...
export default function Navbar() {
    ...
    return (
        <motion.nav
            ...
            className={`fixed top-0 left-0 w-full z-50 bg-white/90 backdrop-blur-lg border-b border-neutral-200 shadow-sm transition-all duration-700 ${scrolled ? "py-1.5" : "py-4"}`}
        >
