                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p className="text-lg text-gray-600 mb-8">
                            Entenda as oportunidades disponíveis em Guararema e encontre o imóvel
                            que combina com seu momento de vida e objetivos.
                        </p>
                        ...
                        <div className="space-y-6">
                            <div className="flex gap-3 items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">Nossa equipe entende suas necessidades específicas</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-3 items-start">
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-900 mb-1">Segurança nas negociações</h3>
                                    <p className="text-gray-600">Acompanhamento jurídico em todas as etapas</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-3 items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">Retornamos seu contato em até 24h</p>
                                </div>
                            </div>
                        </div>
                    </div>
