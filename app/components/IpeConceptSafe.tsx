...
import SafeMotionComponent from './ui/SafeMotionComponent';
import { useIsHydrated } from '../hooks/useHydrationSafeState';

interface IpeInstitutionalProps {
    className?: string;
}

export default function IpeConceptSafe({ className }: IpeInstitutionalProps) {
    const containerRef = useRef<HTMLDivElement>(null);
    const isInView = useInView(containerRef, { once: true, margin: '-80px' });
    const isHydrated = useIsHydrated();

    // Força visibilidade se isInView falhar
    const safeVisibility = isInView || typeof window === 'undefined';
                ...
                <div className="container mx-auto px-6 relative">
                    ...
                    >
                        ...
                        >
                            ...
                            <h2 id="ipe-concept-heading" className="text-5xl lg:text-7xl font-light text-stone-900 mb-8 leading-[0.95] tracking-tight">
                                Expertise que{' '}
