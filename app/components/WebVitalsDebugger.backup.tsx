        ...
        const observer = new PerformanceObserver((entryList) => {
            for (const entry of entryList.getEntries()) {
                ...
                if (entry.entryType === 'largest-contentful-paint') {
                    ...
                    console.log('[LCP] Tamanho:', lcpEntry.size);                    // Destacar visualmente
        ...
        const observer = new PerformanceObserver((entryList) => {
            for (const entry of entryList.getEntries()) {
                ...
                if (!clsEntry.hadRecentInput) {
                    ...
                    console.log('[CLS] Acumulado:', cumulativeScore.toFixed(4)); if (clsEntry.sources && clsEntry.sources.length) {
        ...
        const observer = new PerformanceObserver((entryList) => {
            ...
            events.forEach(event => {
                ...
                if (inpEntry.duration > 200) {
                    ...
                    console.log(`[INP] Duração: ${inpEntry.duration.toFixed(1)}ms`); console.log('[INP] Elemento:', inpEntry.target);
