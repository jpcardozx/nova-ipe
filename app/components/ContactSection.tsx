            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            <label htmlFor="name" className="block mb-1 text-sm font-medium">Nome</label>
                            <input
                                type="text"
                                id="name"
                                name="name"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            <label htmlFor="phone" className="block mb-1 text-sm font-medium">Telefone</label>
                            <input
                                type="tel"
                                id="phone"
                                name="phone"
                        ...
                        <div>
                            <label htmlFor="interest" className="block mb-1 text-sm font-medium">Interesse</label>
                            <select
                                id="interest"
                                name="interest"
                            ...
                            >
                                ...
                                <option value="venda">Vender um imóvel</option>
                    ...
                    <button
                        ...
                        className="inline-flex items-center px-4 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors disabled:opacity-70"
                    >
