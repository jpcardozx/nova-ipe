...
export default function ComprarPage({ imoveis = [] }: ComprarPageProps) {
    ...
    return (
        <section className="bg-[#F9F8F5] text-[#0D1F2D] pb-20">
            <Navbar />
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
                <div className="text-center mb-16">
                    ...
                    <p className="text-base md:text-lg mt-4 text-[#0D1F2D]/70 max-w-2xl mx-auto">
                        Seleção exclusiva com foco em segurança jurídica e bem-estar. Todos os imóveis são verificados e possuem documentação pronta para transferência.
                    </p>
                </div>
                ...
                {imoveis.length > 0 ? (
                    ...
                    <div className="text-center py-20">
                        <p className="text-lg text-[#0D1F2D]/70">
                            Nenhum imóvel disponível no momento. Atualize novamente em breve.
                        </p>
                    </div>
                )}
                ...
                <div className="text-center mt-20">
                    <p className="text-base text-[#0D1F2D]/70 mb-3 max-w-xl mx-auto">
                        Não encontrou o imóvel ideal? Fale com nossa equipe e receba recomendações personalizadas.
                    </p>
                    <Link
                        href="/contato"
