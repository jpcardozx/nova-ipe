...
function PaneHeaderCreateButton(t0) {
  ...
  let t3;
  t3 = !isTemplatePermissionsLoading && templatePermissions?.every(_temp$m);
...
function MissingSchemaType(props) {
  ...
  let t6;
  return $[12] !== layout || $[13] !== t2 || $[14] !== t5 ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(sanity.SanityDefaultPreview, { title: t2, subtitle: t5, media: _temp$l, layout }), $[12] = layout, $[13] = t2, $[14] = t5, $[15] = t6) : t6 = $[15], t6;
}
function _temp$l() {
...
function usePathSyncChannel(t0) {
  ...
  if ($[3] !== id || $[4] !== syncChannel) {
    ...
    $[6] !== id ? (t42 = (t5) => {
      ...
      return source !== id;
    }, $[6] = id, $[7] = t42) : t42 = $[7], t3 = syncChannel.pipe(rxjs.distinctUntilChanged(_temp$i), rxjs.filter(t42), rxjs.map(_temp2$7)), $[3] = id, $[4] = syncChannel, $[5] = t3;
  } else
    t3 = $[5];
  t2 = t3;
  const path = t2;
...
`, DiffViewPane = React.forwardRef(function(t0, ref) {
  ...
  const compareValue = useCompareValue(t1), [patchChannel] = React.useState(_temp$h);
  let t2;
...
function InsufficientPermissionBanner(t0) {
  ...
  let roleTitles, t4;
  $[3] !== currentUserRoles || $[4] !== listFormat ? (roleTitles = currentUserRoles.map(_temp$e), t4 = listFormat.formatToParts(roleTitles).map(_temp2$5), $[3] = currentUserRoles, $[4] = listFormat, $[5] = roleTitles, $[6] = t4) : (roleTitles = $[5], t4 = $[6]);
  const roles = t4;
  let t5;
  $[7] !== roles ? (t5 = {
...
function AddToReleaseBanner({
  ...
  }), /* @__PURE__ */ jsxRuntime.jsx(Banner, { tone, content: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, children: /* @__PURE__ */ jsxRuntime.jsx(sanity.Translate, { i18nKey: "banners.release.not-in-release", t, values: {
